...
public class RenterProfileEdit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_renter_profile_edit);
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (email.getText() == null || password.getText() == null || confirmPassword.getText() == null ||
                    ...
                    Toast.makeText(RenterProfileEdit.this, "Enter an email, password and confirm the password",
    ...
    public boolean validate(String email, String password, String confirm,
        ...
        if (!isValidEmail(email)) {
            Toast.makeText(RenterProfileEdit.this, "Invalid email",
                    Toast.LENGTH_SHORT).show();
            return false;
        } else if (!isValidPassword(password)) {
            Toast.makeText(RenterProfileEdit.this, "Invalid password, must be at least 8 characters",
                    Toast.LENGTH_LONG).show();
            return false;
        }else if (!password.equals(confirm)){
            Toast.makeText(RenterProfileEdit.this, "Passwords do not match",
                    Toast.LENGTH_LONG).show();
            return  false;
        }else if (!isValidName(name)) {
            Toast.makeText(RenterProfileEdit.this, "Invalid Name, must be alphabetical characters",
                    Toast.LENGTH_LONG).show();
            return false;
        }else if (!isValidContactNumber(contactNum)) {
            Toast.makeText(RenterProfileEdit.this, "Invalid contact number",
                    Toast.LENGTH_LONG).show();
            return false;
        } else{
            return true;
    ...
    private void updateEmail(String email) {
        ...
        user.updateEmail(email).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    Toast.makeText(RenterProfileEdit.this, "Email Changed", Toast.LENGTH_LONG).show();
                }
            }
        });
    }
    ...
    private void updatePassword(String password) {
        ...
        user.updatePassword(password).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    Toast.makeText(RenterProfileEdit.this, "Password Changed", Toast.LENGTH_LONG).show();
                }
            }
        });
    }
    ...
    private void updateNameOrContactNum(String dataType, String data){
        String user_id = mAuth.getCurrentUser().getUid();
        db.collection("RentersDetails").document(user_id)
                .update(dataType, data).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    Toast.makeText(RenterProfileEdit.this, dataType + "Changed",
                            Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(RenterProfileEdit.this, "Firestore Error: "
    ...
    private void tryRegister(String email, String password, String confirm,
        ...
        if (!validate(email, password, confirm, name, contactNum)) {
            ...
            if(currentDataOnDb.get("name").equals(name)){
                Toast.makeText(RenterProfileEdit.this, "Name still same",
                        Toast.LENGTH_LONG).show();
            }else {
                Toast.makeText(RenterProfileEdit.this, "Not same",
                        Toast.LENGTH_LONG).show();
            }
        }
    }
