...
public class RenterLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        password = (EditText) findViewById(R.id.passwordTextEditRenterLogin);
        ...
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (email.getText() == null || password.getText() == null || email.getText().toString().length() == 0 || password.getText().toString().length() == 0) {
                    Toast.makeText(RenterLogin.this, "Enter an email and password",
    ...
    public void openRenterRegister() {
        Intent intent = new Intent(this, RenterRegister.class);
    ...
    public boolean validate(String email, String password) {
        if (!isValidEmail(email)) {
            Toast.makeText(RenterLogin.this, "Invalid email",
                    Toast.LENGTH_SHORT).show();
            return false;
        } else if (!isValidPassword(password)) {
            Toast.makeText(RenterLogin.this, "Invalid password, must be at least 8 characters",
                    ...
                    .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                Toast.makeText(RenterLogin.this, "Authentication success.",
                                        Toast.LENGTH_SHORT).show();
                                ...
                                Toast.makeText(RenterLogin.this, "Authentication failed.",
                                        Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
