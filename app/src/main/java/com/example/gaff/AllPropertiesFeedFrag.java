 ...
 * Use the {@link AllPropertiesFeedFrag#newInstance} factory method to
 * create an instance of this fragment.
 */
public class AllPropertiesFeedFrag extends Fragment implements RecyclerViewInterface{
    ...
    public static AllPropertiesFeedFrag newInstance(String param1, String param2) {
        AllPropertiesFeedFrag fragment = new AllPropertiesFeedFrag();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return  inflater.inflate(R.layout.fragment_all_properties_feed, container, false);
    }
    ...
    private void EventChangeListener() {
        ...
        db.collectionGroup("UserAddedProperties")
                .orderBy("addressLine1", Query.Direction.ASCENDING)
