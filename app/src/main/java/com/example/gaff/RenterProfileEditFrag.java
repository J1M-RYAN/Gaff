 ...
 */
public class RenterProfileEditFrag extends Fragment {
    ...
    public static RenterProfileEditFrag newInstance(String param1, String param2) {
        RenterProfileEditFrag fragment = new RenterProfileEditFrag();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_renter_profile_edit, container, false);
    ...
    public void openRenterHome() {
        Intent intent = new Intent(getActivity(), RenterLogin.class);
